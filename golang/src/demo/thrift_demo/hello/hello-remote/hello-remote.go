...
func main() {
  ...
  case "helloString":
    ...
    value0 := argvalue0
    fmt.Print(client.HelloString(context.Background(), value0))
    fmt.Print("\n")
    break
  case "helloInt":
    if flag.NArg() - 1 != 1 {
    ...
    value0 := argvalue0
    fmt.Print(client.HelloInt(context.Background(), value0))
    fmt.Print("\n")
    break
  case "helloBoolean":
    if flag.NArg() - 1 != 1 {
    ...
    value0 := argvalue0
    fmt.Print(client.HelloBoolean(context.Background(), value0))
    fmt.Print("\n")
    break
  case "helloVoid":
    if flag.NArg() - 1 != 0 {
    ...
    fmt.Print(client.HelloVoid(context.Background()))
    fmt.Print("\n")
    break
  case "helloNull":
    if flag.NArg() - 1 != 0 {
    ...
    fmt.Print(client.HelloNull(context.Background()))
    fmt.Print("\n")
    break
  case "":
    Usage()
