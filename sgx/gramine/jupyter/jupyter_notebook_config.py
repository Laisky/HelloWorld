...
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$BTkbYIOjcTlVQTfKCxQeOA$ea8Erh7sn0vqxkrcjXp/2OQolHi/JYYl1j6Pj9EN2hg'
...
#  Choices: any of ['sha3_512', 'md5', 'sha3_256', 'sha3_384', 'sha1', 'sha3_224', 'sha512', 'blake2s', 'sha384', 'sha224', 'blake2b', 'sha256']
#  Default: 'sha256'
